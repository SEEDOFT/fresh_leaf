  ...
  void _seedPolicy() {
    sections.assignAll(<PolicySection>[
      ...
      const PolicySection(
        ...
        body:
            'Use of FreshLeaf requires a valid account, accurate delivery info, and compliance with local regulations. Orders may be canceled if payment fails or address is unreachable.',
      ),
    ]);
  }
}
